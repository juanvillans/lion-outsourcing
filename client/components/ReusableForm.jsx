...
export default function ReusableForm({
  ...
  return (
    <form onSubmit={handleSubmit} className={`space-y-4  ${className}`}>
      ...
      <div className="flex justify-end space-x-4 pt-4 gap-3">
        {showCancelButton && (
          <Button
            type="button"
            variant="outlined"
        ...
        <button
          ...
          {...submitButtonProps}
          className={`px-10 cursor-pointer m rounded hover:opacity-80 font-bold ${submitText == "Actualizar" ? "bg-color4 text-color1" : "bg-caribean-sea text-color4"}`}
        >
