...
const Modal = ({ 
  ...
  return createPortal(
    <div 
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 transition-opacity p-4 md:p-7"
    ...
    >
      ...
      >
        <div className="flex items-center justify-between p-4 border-b shrink-0">
          <h3 id="modal-title" className="text-lg text-gray-800 font-medium">{title}</h3>
          <button
            type="button"
